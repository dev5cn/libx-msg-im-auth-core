...
#ifndef WS_XMSGIMAUTHWEBSOCKETLOG_H_
#define WS_XMSGIMAUTHWEBSOCKETLOG_H_

#include <libx-msg-im-xsc.h>

class XmsgImAuthWebSocketLog: public XmsgImWebSocketLog
{
public:
...
public:
	XmsgImAuthWebSocketLog();
	virtual ~XmsgImAuthWebSocketLog();
};
